...
namespace Expense_Tracker.Controllers
{
    public class TransactionController : Controller
    {
        ...
        {
            List<Category> categories = _context.Categories.ToList(); // Assuming db is your DbContext
            List<SelectListItem> categoryListItems = categories
                .Select(c => new SelectListItem
                {
                    Value = c.CategoryId.ToString(), // Assuming Id is int
                    Text = c.Title // Assuming Name is string
                })
                .ToList();
        ...
        {
            List<Category> CategoryCollection = _context.Categories.ToList();
